...
function FillUrls(cookieName) {
    ...
    if (urls != '') {
        ...
        for (var i = 0; i < urllist.length; i++) {
            ...
            html += "<li><a href=\"javascript:InputSetValue('" + textval + "');\"><input type='button' style='cursor: pointer; cursor: hand;' value='删除' onclick=\"ToolBoxDeleteValue('" + textval + "');\" /> " + textval + "</a></li>";
        }
    }
    else {
        html += "<li>没有记录</li>"
